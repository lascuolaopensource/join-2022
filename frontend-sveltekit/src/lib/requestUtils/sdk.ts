...
export type GenericMorph = Area | ComponentTimeMeeting | ComponentTimeTimeSlot | Course | Enrollment | I18NLocale | UploadFile | UserInfo | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type GetCorsiQuery = { __typename?: 'Query', courses?: { __typename?: 'CourseEntityResponseCollection', data: Array<{ __typename?: 'CourseEntity', attributes?: { __typename?: 'Course', title: string, enrollmentDeadline?: string | null | undefined, slug?: string | null | undefined, meetings?: Array<{ __typename?: 'ComponentTimeMeeting', date?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined }> } | null | undefined };
...
export type GetCourseBySlugQuery = { __typename?: 'Query', courses?: { __typename?: 'CourseEntityResponseCollection', data: Array<{ __typename?: 'CourseEntity', id?: string | null | undefined, attributes?: { __typename?: 'Course', title: string, description?: string | null | undefined } | null | undefined }> } | null | undefined };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getCorsi(variables?: GetCorsiQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetCorsiQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetCorsiQuery>(GetCorsiDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getCorsi');
    },
    getCourseBySlug(variables: GetCourseBySlugQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetCourseBySlugQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetCourseBySlugQuery>(GetCourseBySlugDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getCourseBySlug');
    }
  };
}
