...
class BaseSchema {
  ...
  clone(spec) {
    ...
    next.spec = clone(_extends$3({}, this.spec, spec));
    return next;
  }
...
(function (Schemas) {
   ...
   * Basic schemas
   */
  Schemas.url = create$2().lowercase().matches(Regex.url);
  Schemas.cf = create$2().uppercase().matches(Regex.cf);
  Schemas.vat = create$2().matches(Regex.vat);
  Schemas.sdi = create$2().uppercase().matches(Regex.sdi);
  Schemas.phone = create$2().matches(Regex.phone);
  Schemas.email = create$2().email();
  Schemas.pec = Schemas.email.matches(Regex.pec);
  Schemas.provincia = create$2().uppercase().matches(Regex.provincia);
  Schemas.cap = create$2().matches(Regex.cap);
  /**
   * Yup dynamic checks
   */
...
//
const path$a = "/account/register";
const method$a = HTTPMethod$1.POST;
const values$6 = {
  name: "",
  surname: "",
  email: "",
...
const schema$8 = create$1({
  name: create$2().required(),
  surname: create$2().required(),
  email: Schemas.email.required(),
  password: create$2().required()
}).required();
async function send$a(data, fetchImpl = fetch) {
  return send$b({
    path: path$a,
    method: method$a,
    data,
...
(function (UserExists) {
  ...
  UserExists.schema = create$1({
    email: Schemas.email.required()
  }).required();
})(UserExists || (UserExists = {}));

//
const path$9 = "/auth/local";
const method$9 = HTTPMethod.POST;
const values$5 = {
  identifier: "",
  password: ""
};
const schema$7 = create$1({
...
//
const path$8 = "/auth/forgot-password";
const method$8 = HTTPMethod$1.POST;
const values$4 = {
  email: ""
};
const schema$6 = create$1({
  email: Schemas.email.required()
}).required();
...
//
const path$7 = "/auth/reset-password";
...
const schema$5 = create$1({
  password: create$2().required(),
  passwordConfirmation: create$2().required(),
  code: create$2().required()
}).required();
...
const path$6 = "/users/me?populate=info&populate=role";
const method$6 = HTTPMethod.GET;
async function send$6(token, fetchImpl = fetch) {
  return send$b({
    path: path$6,
    method: method$6,
    auth: token,
...
const schema$4 = create$1({
  email: create$2().email().when(USER_EXISTS, Schemas.thenReq(false)),
  name: create$2().when(USER_EXISTS, Schemas.thenReq(false)),
  surname: create$2().when(USER_EXISTS, Schemas.thenReq(false)),
...
(function (Evaluation) {
  ...
  Evaluation.schema = create$1({
    letter: create$2().when("$letterNeeded", Schemas.thenReq(true)),
    portfolio: create$2().when("$portfolioNeeded", Schemas.thenUrlReq(true)),
    cv: create$2().when("$cvNeeded", Schemas.thenUrlReq(true))
  });
...
(function (Address) {
  ...
  Address.schema = create$1({
    country: create$2().required(),
    administrativeArea: Schemas.provincia.required(),
    city: create$2().required(),
    postCode: Schemas.cap.required(),
    street: create$2().required(),
    number: create$2().required()
  });
})(Address || (Address = {}));
...
function path$5(params = defaultParams$1) {
...
const schema$3 = create$1({
  billingOption: create$2().oneOf([...Options]).required(),
...
async function send$5(paymentID, data, fetchImpl = fetch) {
  return send$b({
    path: path$5({
      id: paymentID
    }),
...
const method$4 = HTTPMethod$1.GET;
async function send$4(id, fetchImpl = fetch) {
  return send$b({
    path: path$4({
      id
    }),
...
//
const path$3 = "/pay/confirm";
const method$3 = HTTPMethod$1.POST;
const schema$2 = create$1({
  confirmationCode: create$2().required()
});
async function send$3(confirmationCode, fetchImpl = fetch) {
  return send$b({
    path: path$3,
    method: method$3,
    data: {
...
//
const path$2 = "/admin-enrollments/update";
const method$2 = HTTPMethod$1.POST;
const itemSchema = create$1({
  id: create$2().required(),
  state: create$2().oneOf(EnrollmentStates).required()
});
const schema$1 = create$1({
  items: create(itemSchema).required()
});
async function send$2(data, auth, fetchImpl = fetch) {
  return send$b({
    path: path$2,
    method: method$2,
    data,
...
//
const method$1 = HTTPMethod$1.GET;
const defaultParams = {
  id: ":id"
};
function path$1(params = defaultParams) {
  return `/admin-enrollments/confirm-course/${params.id}`;
}
async function send$1(courseID, auth, fetchImpl = fetch) {
  return send$b({
    path: path$1({
      id: courseID
    }),
